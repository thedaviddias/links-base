...
export default function NotFound() {
  return (
    <main className="mx-autorelative container flex flex-col items-center justify-center px-4">
      <div className="mx-auto flex h-screen flex-col items-center justify-center">
        <div className="flex h-full flex-col items-center justify-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-center text-base font-medium text-neutral-400">
            ...
            <Link
              href="https://github.com/thedaviddias/links-base/issues/new/choose"
